...
import { getFollowersByOffset, getUserFollowersCount } from "../db/queries/followers.js";
import { createOrderedCollection, createOrderedCollectionPage } from "../activitypub/collections.js";
...
export const handleFollowersCollectionRequest = async (
  ...
  try {
    ...
    const followersEntries = await getFollowersByOffset(
      offsetValue,
      PAGE_SIZE,
    );
